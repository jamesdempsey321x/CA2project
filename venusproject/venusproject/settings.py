"""
Django settings for venusproject project.
...
SECRET_KEY = 'django-insecure-i6*h_9=hh%q!p7vic3+*gxj*q6rz4th@(h_zh@@r#eulrb#r9b'
...
ROOT_URLCONF = 'venusproject.urls'
...
WSGI_APPLICATION = 'venusproject.wsgi.application'
...
LOGIN_REDIRECT_URL = 'shop:all_prod_list'
LOGOUT_REDIRECT_URL = 'shop:all_prod_list'
